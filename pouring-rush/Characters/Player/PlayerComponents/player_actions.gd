...
## Shared names for input map actions related to the player character controls
...
@export var special1 : StringName = "Special1"
@export var special2 : StringName = "Special2"
